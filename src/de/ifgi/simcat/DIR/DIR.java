...
public class DIR {
	...
	/**
	 * Returns the DIR measure for this pair of rankings based on the <b>ranked
	 * order</b> of the items in the input rankings.
	 * 
	 * @param a
	 * @param b
	 * @return
	...
	/**
	 * Returns the DIR measure for this pair of rankings based on the
	 * <b>relevance</b> of the items in the input rankings.
	 * 
	 * @param a
	 * @param b
	 * @return
	...
	/**
	 * Helper method for getDIRrel - should not be used directily.
	 * 
	 */
	...
	/**
	 * Helper method for getDIRrank - should not be used directily.
	 */
